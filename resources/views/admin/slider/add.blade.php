    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <form action="{{Route('slider-add')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form-body">
                        ...
                        <div class="form-group {{ $errors->has('background_image') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                ...
                                <span> Image resolution must be with 16:9 ratio. </span>
                        ...
                        <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea rows="5" class="form-control" placeholder="Description" name="description"  id="description">{{ (old('description')!="") ? old('description') : '' }}</textarea>
